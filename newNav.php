...
<body class="nav_body">
    <nav>
        <ul>
            ...
            <li><a href="view.php"><span class="material-symbols-outlined">preview</span>作品閲覧</a></li>
            <li><a href="view.php"><span class="material-symbols-outlined">quick_reference_all</span>質問閲覧</a></li>
            <li><a href="upload.php"><span class="material-symbols-outlined">drive_folder_upload</span>作品を投稿</a></li>
